...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        county_vote_percentage = county_turnout / total_votes * 100

        # 6d: Print the county results to the terminal.
        county_results = (f"{county}: {county_vote_percentage:.1f}% ({county_turnout:,})")
        ...
        if county_turnout > largest_turnout:
